...
(function(){
  ...
  function TextBox( controller ) {
    ...
    function render() {
      if (lines) {
        ...
        lines.forEach( function( line ) {
          Game.canvas.drawText( bounds.left + instance.offset.x, bounds.top + instance.offset.y, instance.color, line, instance.fontSize, bounds.width() );
    ...
    function update() {
      ...
      lines = [];
      Game.canvas.setDrawTextContext( instance.color, instance.fontSize );
      while (words.length) {
